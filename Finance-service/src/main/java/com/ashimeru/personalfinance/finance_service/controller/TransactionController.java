...
public class TransactionController {
  ...
  public ResponseEntity<TransactionEntity> createTransaction(
    ...
    public ResponseEntity<List<TransactionEntity>> getAllTransactions(Authentication authentication) {
        Long userId = (Long) authentication.getPrincipal();
        List<TransactionEntity> transactions = this.service.getTransactionsByUserId(userId);
